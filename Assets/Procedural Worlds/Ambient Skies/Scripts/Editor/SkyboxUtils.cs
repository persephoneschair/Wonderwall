    ...
    public static class SkyboxUtils
    {
...
#else
        public static UniversalRenderPipelineAsset lightweightRender;
#endif
                ...
                if (volumeObject != null)
                {
                    ...
                    if (volumeProfile != null)
                    {
                        ...
                        if (volumeProfile.TryGet(out visualEnvironment))
                        {
                            ...
                            {
                                UnityEngine.Rendering.HighDefinition.HDRISky hDRISky;
        ...
        public static bool CreateProfileFromActiveSkybox(AmbientSkyProfiles profiles)
        {
            ...
            AmbientSkyboxProfile profile = new AmbientSkyboxProfile
            {
                ...
                assetName = skyboxTexture.name,
                skyboxTint = skyMaterial.GetColor("_Tint"),
                skyboxExposure = skyMaterial.GetFloat("_Exposure"),
                skyboxRotation = skyMaterial.GetFloat("_Rotation"),
                skyboxGroundIntensity = RenderSettings.ambientIntensity,
        ...
        public static void SetSkybox(AmbientSkyProfiles skyProfiles, AmbientSkyboxProfile profile, AmbientProceduralSkyboxProfile proceduralProfile, AmbientGradientSkyboxProfile gradientProfile, bool useDefaults, AmbientSkiesConsts.RenderPipelineSettings renderPipelineSettings, bool updateVisualEnvironment, bool updateFog, bool updateShadows, bool updateAmbientLight, bool updateScreenReflections, bool updateScreenRefractions, bool updateSun)
        {
            ...
            else
            {
                ...
                {                   
                    ...
                    {
                        HorizonUtils.RemoveHorizonSky(skyProfiles.m_multiSceneSupport);
                    }
                }
                else
                {
                    RemoveTimeOfDay(skyProfiles);

                    RemoveHorizonSky();

                    DestroyParent("Ambient Skies Global", skyProfiles.m_multiSceneSupport);
                }

                AmbientSkiesEditorFunctions.MarkActiveSceneAsDirty(skyProfiles);
            }
        }
        ...
        private static void SetSkyboxSettings(AmbientSkyProfiles skyProfiles, AmbientSkyboxProfile profile, AmbientGradientSkyboxProfile gradientProfile, AmbientProceduralSkyboxProfile proceduralProfile, bool isHDRP, AmbientSkiesConsts.RenderPipelineSettings renderPipelineSettings, bool updateVisualEnvironment, bool updateFog, bool updateShadows, bool updateAmbientLight, bool updateScreenReflections, bool updateScreenRefractions, bool updateSun)
        {
            ...
            if (skyProfiles.m_systemTypes == AmbientSkiesConsts.SystemTypes.AmbientHDRISkies)
            {
                ...
                if (renderPipelineSettings != AmbientSkiesConsts.RenderPipelineSettings.HighDefinition)
                {
                    ...
                    if (updateVisualEnvironment)
                    {
                        ...
                        skyProfiles.m_skyboxMaterial = RenderSettings.skybox;
                    }

                    RemoveHDRPObjects(skyProfiles);
                }
                else
                {
                    if (updateSun)
...
#else
                        AmbientSkiesPipelineUtils.SetupHDEnvironmentalVolume(profile, proceduralProfile, gradientProfile, skyProfiles, profile.profileIndex, renderPipelineSettings, "High Definition Environment Volume", "2019.3 HDRP Sky Profile", updateVisualEnvironment, updateFog, updateShadows, updateAmbientLight, updateScreenReflections, updateScreenRefractions, updateSun);
#endif
                    }
                }
            ...
            else if (skyProfiles.m_systemTypes == AmbientSkiesConsts.SystemTypes.DefaultProcedural)
            {
                if (renderPipelineSettings != AmbientSkiesConsts.RenderPipelineSettings.HighDefinition)
                {
                    ...
                    RemoveDensityFogVolume(skyProfiles);
        ...
        public static void SetGaiaSetup(AmbientSkyProfiles skyProfiles)
        {
            ...
            #if GAIA_PRO_PRESENT
            GameObject ProSky = GameObject.Find("Gaia Weather");
            if (ProSky != null)
            {
                GameObject.DestroyImmediate(ProSky);
            }
            #endif
        ...
        /// </summary>
        public static void RemoveDensityFogVolume(AmbientSkyProfiles skyProfiles)
        {
        ...
        public static VolumeProfile GetVolumeProfile()
        {
            ...
            GameObject parentObject = GetOrCreateParentObject("Ambient Skies Global", false);
            GameObject volumeObject = GameObject.Find("High Definition Environment Volume");
            if (volumeObject == null)
            {
        ...
        public static void SetQualitySettings(AmbientSkyProfiles skyProfiles, AmbientSkyboxProfile profile, AmbientProceduralSkyboxProfile proceduralProfile, AmbientGradientSkyboxProfile gradientProfile)
        {
            if (skyProfiles.m_systemTypes == AmbientSkiesConsts.SystemTypes.AmbientHDRISkies)
            {
                ...
                if (lightweightRender == null)
                {
                    lightweightRender = AssetDatabase.LoadAssetAtPath<UniversalRenderPipelineAsset>(GetAssetPath("Procedural Worlds Lightweight Pipeline Profile Ambient Skies"));
                ...
                {
                    if (pipelineAsset.shadowDistance != profile.shadowDistance)
                    {
        ...
        public static void LoadSkyboxMaterial(AmbientSkyProfiles skyProfiles, AmbientSkyboxProfile profile, AmbientProceduralSkyboxProfile proceduralProfile, AmbientGradientSkyboxProfile gradientProfile, bool isHDRI)
        {
            ...
            if (isHDRI)
            {
                ...
                if (loadSkyboxTexture)
                {
                    ...
                    {
                        if (profile.creationHDRIAsset == null)
                        {
                            hdrSkyPath = "";
                        }
                        else
                        {
                            hdrSkyPath = GetAssetPath(profile.creationHDRIAsset.name);
                        }
                    }
                    else
                    {
                    ...
                    if (string.IsNullOrEmpty(hdrSkyPath))
                    {
                        if (skyProfiles.m_showDebug)
                        {
                            Debug.LogErrorFormat("AmbientSkies:SetSkybox : Unable to load '{0} {1}' skybox asset - Aborting! ", profile.assetName, " Please ensure you have a cubemap selected");
                        }
        ...
        public static void SetGaiaParenting(bool alsoReparent)
        {
            ...
            {
                newParentObject = GetOrCreateParentObject("Ambient Skies Global", false);
            }
        ...
        public static void SetTimeOfDaySettings(AmbientProceduralSkyboxProfile profile, AmbientSkyProfiles skyProfiles)
        {
            ...
            if (timeOfDay != null)
            {
                ...
                timeOfDay.m_timeOfDayProfile.m_pBSGroundColor = skyProfiles.m_pBSGroundColor;
                timeOfDay.m_timeOfDayProfile.m_pBSAreosolDensity= skyProfiles.m_pBSAreosolDensity;
                timeOfDay.m_timeOfDayProfile.m_pBSSpaceEmissionTexture = skyProfiles.m_pBSSpaceEmissionTexture;
                timeOfDay.m_timeOfDayProfile.m_pBSSpaceEmissionMultiplier = skyProfiles.m_pBSSpaceEmissionMultiplier;

                timeOfDay.m_timeOfDayProfile.m_currentTime = skyProfiles.m_currentTimeOfDay;
                timeOfDay.CurrentTime = skyProfiles.m_currentTimeOfDay;
        ...
        /// </summary>
        public static void RemoveTimeOfDay(AmbientSkyProfiles skyProfiles)
        {
        ...
        /// </summary>
        public static void RemoveHDRPObjects(AmbientSkyProfiles skyProfiles)
        {
        ...
        public static GameObject GetOrCreateParentObject(string parentGameObject, bool parentToGaia)
        {
            ...
            if (theParentGo == null)
            {
                ...
                {
                    theParentGo.name = parentGameObject;
                }
            }
        ...
        public static GameObject GetOrCreateMainCamera()
        {
            ...
            if (mainCameraObj == null)
            {
                mainCameraObj = new GameObject("Main Camera") {tag = "MainCamera"};
        ...
        public static void DestroyParent(string parentGameObject, bool multiSceneSupport)
        {
            //If string isn't empty
            if(!string.IsNullOrEmpty(parentGameObject))
            {
                //If string doesn't = Ambient Skies Global
                if (parentGameObject != "Ambient Skies Global")
                {
                    //Sets the paramater to Ambient Skies Global
                    parentGameObject = "Ambient Skies Global";
                }
