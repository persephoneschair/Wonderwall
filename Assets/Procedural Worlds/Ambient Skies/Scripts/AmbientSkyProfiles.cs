...
namespace AmbientSkies
{
    ...
    public class AmbientSkyProfiles : ScriptableObject
    {
        ...
        [SerializeField]
        public bool m_multiSceneSupport = true;
        ...
        [SerializeField]
        [HideInInspector]
        public AmbientSkiesConsts.HDRPVisualQuality m_hdrpVisualQuality = AmbientSkiesConsts.HDRPVisualQuality.Medium;

        [SerializeField]
        [HideInInspector]
        public bool m_enableTextureStreaming = false;
        ...
        [SerializeField]
        [HideInInspector]
        public Gradient m_pBSGroundColor;

        [SerializeField]
        [HideInInspector]
        public AnimationCurve m_pBSAreosolDensity;

        [SerializeField]
        [HideInInspector]
        public Cubemap m_pBSSpaceEmissionTexture;

        [SerializeField]
        [HideInInspector]
        public float m_pBSSpaceEmissionMultiplier;
        ...
        /// </summary>
        /// <param name="hdriProfileIdx"></param>
        /// <param name="proceduralProfileIdx"></param>
        /// <param name="gradientProceduralIdx"></param>
        public void RevertSkyboxSettingsToDefault(int hdriProfileIdx, int proceduralProfileIdx, int gradientProceduralIdx)
        {
            switch (m_systemTypes)
            {
        ...
        public void RevertAllDefaults(AmbientSkiesConsts.RenderPipelineSettings renderPipelineSettings)
        {
            ...
            if (m_selectedRenderPipeline != AmbientSkiesConsts.RenderPipelineSettings.HighDefinition)
            {
            ...
            DestroyParent("Ambient Skies Global");
        ...
        public static void DestroyParent(string parentGameObject)
        {
            ...
            {
                //Sets the parameter to Ambient Skies Global
