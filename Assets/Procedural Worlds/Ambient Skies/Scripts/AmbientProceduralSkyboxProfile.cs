...
namespace AmbientSkies
{
    ...
    public class AmbientProceduralSkyboxProfile
    {
        ...
        [Header("HD Physically Based Sky")]
        //Planet
        public bool defaultPBSEarthPreset = true;
        public bool defaultPBSSphericalMode = true;
        public Vector3 defaultPBSPlanetCenterPosition = new Vector3(0, -6378100, 0);
        public Vector3 defaultPBSPlanetRotation = new Vector3(0, -0, 0);
        public Cubemap defaultPBSGroundColorTexture;
        public Color defaultPBSGroundTint = new Color(0.255874f, 0.350156f, 0.4339623f);
        public Cubemap defaultPBSGroundEmissionTexture;
        public float defaultPBSGroundEmissionMultiplier = 1f;
        //Space
        public Vector3 defaultPBSSpaceRotation = new Vector3(0, 0, 0);
        public Cubemap defaultPBSSpaceEmission;
        public float defaultPBSSpaceEmissionMultiplier = 1f;
        //Air
        public float defaultPBSAirMaximumAltitude = 55261.97f;
        public float defaultPBSAirDensityR = 0.04534f;
        public float defaultPBSAirDensityG = 0.1023724f;
        public float defaultPBSAirDensityB = 0.2326406f;
        public Color defaultPBSAirTint = new Color(0.9f, 0.9f, 1f);
        //Aerosols
        public float defaultPBSAerosolMaximumAltitude = 8289.296f;
        public float defaultPBSAerosolDensity = 0.01192826f;
        public Color defaultPBSAerosolTint = new Color(0.9f, 0.9f, 0.9f);
        public float defaultPBSAerosolAnisotropy = 0f;
        //Artistic Overrides
        public float defaultPBSColorSaturation = 1f;
        public float defaultPBSAlphaSaturation = 1f;
        public float defaultPBSAlphaMultiplier = 1f;
        public Color defaultPBSHorizonTint = Color.white;
        public float defaultPBSHorizonZenithShift = 0f;
        public Color defaultPBSZenithTint = Color.white;
        //Miscellaneous
        public int defaultPBSNumberOfBounces = 8;
        public AmbientSkiesConsts.HDRPIntensityMode defaultPBSIntensityMode = AmbientSkiesConsts.HDRPIntensityMode.Multiplier;
        public float defaultPBSExposure = 1f;
        public float defaultPBSMultiplier = 1.5f;
        public AmbientSkiesConsts.EnvironementSkyUpdateMode defaultPBSUpdateMode = AmbientSkiesConsts.EnvironementSkyUpdateMode.OnChanged;
        public bool defaultPBSIncludeSunInBaking = true;
        ...
        [Header("HD Physically Based Sky")]
        //Planet
        public bool pBSEarthPreset = true;
        public bool pBSSphericalMode = true;
        public Vector3 pBSPlanetCenterPosition = new Vector3(0, -6378100, 0);
        public Vector3 pBSPlanetRotation = new Vector3(0, -0, 0);
        public Cubemap pBSGroundColorTexture;
        public Color pBSGroundTint = new Color(0.255874f, 0.350156f, 0.4339623f);
        public Cubemap pBSGroundEmissionTexture;
        public float pBSGroundEmissionMultiplier = 1f;
        //Space
        public Vector3 pBSSpaceRotation = new Vector3(0, 0, 0);
        public Cubemap pBSSpaceEmission;
        public float pBSSpaceEmissionMultiplier = 1f;
        //Air
        public float pBSAirMaximumAltitude = 55261.97f;
        public float pBSAirDensityR = 0.04534f;
        public float pBSAirDensityG = 0.1023724f;
        public float pBSAirDensityB = 0.2326406f;
        public Color pBSAirTint = new Color(0.9f, 0.9f, 1f);
        //Aerosols
        public float pBSAerosolMaximumAltitude = 8289.296f;
        public float pBSAerosolDensity = 0.01192826f;
        public Color pBSAerosolTint = new Color(0.9f, 0.9f, 0.9f);
        public float pBSAerosolAnisotropy = 0f;
        //Artistic Overrides
        public float pBSColorSaturation = 1f;
        public float pBSAlphaSaturation = 1f;
        public float pBSAlphaMultiplier = 1f;
        public Color pBSHorizonTint = Color.white;
        public float pBSHorizonZenithShift = 0f;
        public Color pBSZenithTint = Color.white;
        //Miscellaneous
        public int pBSNumberOfBounces = 8;
        public AmbientSkiesConsts.HDRPIntensityMode pBSIntensityMode = AmbientSkiesConsts.HDRPIntensityMode.Multiplier;
        public float pBSExposure = 1f;
        public float pBSMultiplier = 1.5f;
        public AmbientSkiesConsts.EnvironementSkyUpdateMode pBSUpdateMode = AmbientSkiesConsts.EnvironementSkyUpdateMode.OnChanged;
        public bool pBSIncludeSunInBaking = true;
        [Header("HD Shadow Settings")]
        ...
        public void RevertToDefault()
        {
            ...
            //Earth
            pBSEarthPreset = defaultPBSEarthPreset;
            pBSSphericalMode = defaultPBSSphericalMode;
            pBSPlanetCenterPosition = defaultPBSPlanetCenterPosition;
            pBSPlanetRotation = defaultPBSPlanetRotation;
            pBSGroundColorTexture = defaultPBSGroundColorTexture;
            pBSGroundTint = defaultPBSGroundTint;
            pBSGroundEmissionTexture = defaultPBSGroundEmissionTexture;
            pBSGroundEmissionMultiplier = defaultPBSGroundEmissionMultiplier;
            //Space
            pBSSpaceRotation = defaultPBSSpaceRotation;
            pBSSpaceEmission = defaultPBSSpaceEmission;
            pBSSpaceEmissionMultiplier = defaultPBSSpaceEmissionMultiplier;
            //Air
            pBSAirMaximumAltitude = defaultPBSAirMaximumAltitude;
            pBSAirDensityR = defaultPBSAirDensityR;
            pBSAirDensityG = defaultPBSAirDensityG;
            pBSAirDensityB = defaultPBSAirDensityB;
            pBSAirTint = defaultPBSAirTint;
            //Aerosolos
            pBSColorSaturation = defaultPBSColorSaturation;
            pBSAlphaSaturation = defaultPBSAlphaSaturation;
            pBSAlphaMultiplier = defaultPBSAlphaMultiplier;
            pBSHorizonTint = defaultPBSHorizonTint;
            pBSHorizonZenithShift = defaultPBSHorizonZenithShift;
            pBSZenithTint = defaultPBSZenithTint;
            //Miscellaneous
            pBSNumberOfBounces = defaultPBSNumberOfBounces;
            pBSIntensityMode = defaultPBSIntensityMode;
            pBSExposure = defaultPBSExposure;
            pBSMultiplier = defaultPBSMultiplier;
            pBSUpdateMode = defaultPBSUpdateMode;
            pBSIncludeSunInBaking = defaultPBSIncludeSunInBaking;
        ...
        public void SaveCurrentToDefault()
        {
            ...
            //Earth
            defaultPBSEarthPreset = pBSEarthPreset;
            defaultPBSSphericalMode = pBSSphericalMode;
            defaultPBSPlanetCenterPosition = pBSPlanetCenterPosition;
            defaultPBSPlanetRotation = pBSPlanetRotation;
            defaultPBSGroundColorTexture = pBSGroundColorTexture;
            defaultPBSGroundTint = pBSGroundTint;
            defaultPBSGroundEmissionTexture = pBSGroundEmissionTexture;
            defaultPBSGroundEmissionMultiplier = pBSGroundEmissionMultiplier;
            //Space
            defaultPBSSpaceRotation = pBSSpaceRotation;
            defaultPBSSpaceEmission = pBSSpaceEmission;
            defaultPBSSpaceEmissionMultiplier = pBSSpaceEmissionMultiplier;
            //Air
            defaultPBSAirMaximumAltitude = pBSAirMaximumAltitude;
            defaultPBSAirDensityR = pBSAirDensityR;
            defaultPBSAirDensityG = pBSAirDensityG;
            defaultPBSAirDensityB = pBSAirDensityB;
            defaultPBSAirTint = pBSAirTint;
            //Aerosolos
            defaultPBSColorSaturation = pBSColorSaturation;
            defaultPBSAlphaSaturation = pBSAlphaSaturation;
            defaultPBSAlphaMultiplier = pBSAlphaMultiplier;
            defaultPBSHorizonTint = pBSHorizonTint;
            defaultPBSHorizonZenithShift = pBSHorizonZenithShift;
            defaultPBSZenithTint = pBSZenithTint;
            //Miscellaneous
            defaultPBSNumberOfBounces = pBSNumberOfBounces;
            defaultPBSIntensityMode = pBSIntensityMode;
            defaultPBSExposure = pBSExposure;
            defaultPBSMultiplier = pBSMultiplier;
            defaultPBSUpdateMode = pBSUpdateMode;
            defaultPBSIncludeSunInBaking = pBSIncludeSunInBaking;
