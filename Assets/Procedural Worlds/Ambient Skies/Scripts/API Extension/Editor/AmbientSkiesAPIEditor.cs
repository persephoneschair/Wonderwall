...
{
    [CustomEditor(typeof(AmbientSkiesAPI))]
    public class AmbientSkiesAPIEditor : Editor
    {
        //Box style
        private GUIStyle m_boxStyle;
        //Local variables for functions
        private AmbientSkiesAPI m_settings;

        private CreationToolsSettings m_creationToolSettings;

        //HDRP Changed
        private readonly bool m_updateVisualEnvironment = true;
        private readonly bool m_updateFog = true;
        private readonly bool m_updateShadows = true;
        private readonly bool m_updateAmbientLight = true;
        private readonly bool m_updateScreenSpaceReflections = true;
        private readonly bool m_updateScreenSpaceRefractions = true;
        private readonly bool m_updateSun = true;
        ...
        public override void OnInspectorGUI()
        {
            ...
            AmbientSkiesAPI ambientSkiesSettings = (AmbientSkiesAPI)target;
            ...
            GUILayout.BeginVertical("Profile Selection", m_boxStyle);
            GUILayout.Space(25f);

            if (profiles.m_useSkies)
            {
            ...
            {
                EditorGUILayout.HelpBox("Skies is not enabled. To use skies enable skies in the ambient skies window.", MessageType.Info);
            }

            if (profiles.m_usePostFX)
            {
                EditorGUILayout.BeginHorizontal();
            ...
            {
                EditorGUILayout.HelpBox("Post Processing is not enabled. To use post processing enable it in the ambient skies window.", MessageType.Info);
            }
        ...
        public bool ApplyScriptingDefine()
        {
            ...
            {
                m_settings.m_profiles.m_selectedRenderPipeline = AmbientSkiesConsts.RenderPipelineSettings.Universal;
