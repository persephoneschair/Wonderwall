...
namespace AmbientSkies
{
    public class AmbientSkiesTimeOfDayProfile : ScriptableObject
    {
        ...
        //Sets the ground color in Physically based sky
        public Gradient m_pBSGroundColor;
        //Sets the areosol density in Physically based sky
        public AnimationCurve m_pBSAreosolDensity;
        //Sets the space emission texture in Physically based sky
        public Cubemap m_pBSSpaceEmissionTexture;
        //Sets the space emission multiplier in Physically based sky
        public float m_pBSSpaceEmissionMultiplier = 1f;
